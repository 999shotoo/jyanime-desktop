...
const Header = () => {
  ...
  return (
    <header
      className="fixed  top-0 left-0  right-0 flex justify-between items-center bg-card  h-10 text-foreground z-50 drag p-2 border-b border-border"
    >
      {/* Left side: Title */}
      <div className="text-sm font-semibold select-none">{appTitle}</div>
